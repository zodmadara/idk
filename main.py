...
token = input('7011349399:AAEvWxYQS81tjJE6t87o5B65EIedH9DSAXw')
...
def start(message):
    bot.send_message(
        ...
        'Use /gen followed by a BIN to generate 10 credit card numbers.</strong>',
        parse_mode="HTML"
    )
...
def help_command(message):
    help_text = (
        ...
        "6. /feedback - Send your feedback or report an issue.\n"
    )
